...
# Load mesh
mesh1 = Box(Point(0., 0., 0.), Point(16., 16., 16.))
mesh2 = Box(Point(16., 0., 0.), Point(32., 16., 8.))
mesh = generate_mesh(mesh1 + mesh2, 8)

# Generate 3D mesh from OFF file input (tetrahedron)
# PolyhedralMeshGenerator.generate(mesh, "mesh3d.off", 0.05)
plot(mesh)
